...
This is an uncensored version of [Qwen/Qwen3-30B-A3B-Instruct-2507](https://huggingface.co/Qwen/Qwen3-30B-A3B-Instruct-2507) created with abliteration (see [remove-refusals-with-transformers](https://github.com/Sumandora/remove-refusals-with-transformers) to know more about it).
...
You can use [huihui_ai/qwen3-abliterated:30b-a3b-instruct-2507-q4_K_M](https://ollama.com/huihui_ai/qwen3-abliterated:30b-a3b-instruct-2507-q4_K_M) directly, 
```
ollama run huihui_ai/qwen3-abliterated:30b-a3b-instruct-2507-q4_K_M
```
...
NEW_MODEL_ID = "huihui-ai/Huihui-Qwen3-30B-A3B-Instruct-2507-abliterated"
