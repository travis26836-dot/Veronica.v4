...
def main():
    ...
    if existing is not None:
        ...
        if shutil.disk_usage(staging).free < remaining + 20 * 1024**3:
    ...
    command("uv", "pip", "install", "--python", str(runtime_env / "bin/python"), "vllm==" + runtime["vllmVersion"], "transformers==" + runtime["transformersVersion"], env=env)
